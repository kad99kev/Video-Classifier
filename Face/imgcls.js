...
function setup(){
  ...
  /*seeButton = createButton("See");
  seeButton.mousePressed(function(){
    imgClf.addImage('Face');
  });

  bButton = createButton("Bottle");
  bButton.mousePressed(function(){
    imgClf.addImage('Bottle');
  });*/
  ...
  load.mousePressed(function(){
    imgClf.load('../model.json', customModelReady);
  });
